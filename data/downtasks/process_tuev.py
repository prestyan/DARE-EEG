...
target_dirs = [
    os.path.join(root, "processed", "processed_train"),
    os.path.join(root, "processed", "processed_eval"),
    os.path.join(root, "processed", "processed_test"),
]
